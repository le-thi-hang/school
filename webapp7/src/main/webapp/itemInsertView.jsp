				...
				<section>
					...
					<form action="ItemInsertController" method="post">
						<table>
							<tr>
								...
								<td>
									<select name="categoryid">
										<option style="text-align: " value="">選択</option>
							...
							<tr>
								<th>商品名※</th>
								<td><input type="text" name="itemname" placeholder="商品名" required></td>
							</tr>
							<tr>
								<th>価格※</th>
								<td><input type="number" name="price" placeholder="価格" required></td>
							</tr>
							
							<tr>
								<th>画像※</th>
								<td><input type="text" name="image" placeholder="画像" required></td>
							</tr>
							<tr>
								<th>画像1※</th>
								<td><input type="text" name="image1" placeholder="画像1" required></td>
							</tr>
							<tr>
								<th>画像2</th>
								<td><input type="text" name="image2" placeholder="画像2"></td>
							</tr>
							<tr>
								<th>画像2</th>
								<td><input type="text" name="image3" placeholder="画像3"></td>
							</tr>
							<tr>
								<th>画像4</th>
								<td><input type="text" name="image4" placeholder="画像4"></td>
							</tr>
							<tr>
								<th>画像5</th>
								<td><input type="text" name="image5" placeholder="画像5"></td>
							</tr>
							<tr>
								<th>説明※</th>
								<td><textarea name="detail" placeholder="説明"></textarea></td>
							</tr>
